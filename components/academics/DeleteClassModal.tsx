...
export const DeleteClassModal: React.FC<DeleteClassModalProps> = ({ schoolClass, onClose, onDelete }) => {
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] flex flex-col">
                <div className="flex items-center justify-between p-6 border-b border-slate-200">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-xl font-semibold text-slate-800">Delete Class</h2>
                    </div>
                ...
                <div className="p-6">
                    <p className="text-slate-600">
                        Are you sure you want to delete the class <strong className="font-semibold text-slate-800">{schoolClass.name}</strong>? 
